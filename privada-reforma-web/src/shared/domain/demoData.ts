...
export const reservationStatusSchema = z.enum(['pending_payment', 'active', 'cancelled'])
...
export const reservationSchema = z.object({
  ...
  paymentChargeId: z.string().optional(),
  createdAt: z.string(),
  createdByUserId: z.string(),
})
...
export const financialMovementTypeSchema = z.enum(['income', 'expense'])
export const financialVisibilityScopeSchema = z.enum(['community', 'board_only', 'unit_private'])
export const unitAccountEntryTypeSchema = z.enum(['charge', 'payment', 'adjustment'])
export const unitAccountEntryDirectionSchema = z.enum(['debit', 'credit'])
export const unitAccountEntryStatusSchema = z.enum(['posted', 'pending', 'overdue', 'paid', 'partial'])
...
export const financialPeriodCloseSchema = z.object({
  id: z.string(),
  year: z.number().int().min(2000),
  month: z.number().int().min(1).max(12),
  openingBalanceMxn: z.number().nonnegative(),
  closingBalanceMxn: z.number().nonnegative(),
  notes: z.string().optional(),
  publishedAt: z.string(),
  publishedByUserId: z.string(),
})

export type FinancialPeriodClose = z.infer<typeof financialPeriodCloseSchema>
...
export const financialMovementSchema = z.object({
  ...
  description: z.string(),
  vendorOrSource: z.string().optional(),
  unitNumber: z.string().optional(),
  visibilityScope: financialVisibilityScopeSchema,
...
export const unitAccountEntrySchema = z.object({
  id: z.string(),
  unitNumber: z.string(),
  entryType: unitAccountEntryTypeSchema,
  category: z.string(),
  amountMxn: z.number().positive(),
  direction: unitAccountEntryDirectionSchema,
  occurredAt: z.string(),
  dueAt: z.string().optional(),
  status: unitAccountEntryStatusSchema,
  referenceMovementId: z.string().optional(),
  notes: z.string().optional(),
  createdByUserId: z.string(),
})

export type UnitAccountEntry = z.infer<typeof unitAccountEntrySchema>
...
export const LOCAL_RESERVATIONS: Reservation[] = [
  {
    ...
    paymentStatus: 'paid',
    paymentChargeId: 'charge-local-demo-1',
    createdAt: new Date('2026-02-20T12:00:00-08:00').toISOString(),
    createdByUserId: 'acc-resident-1',
  },
]
export const LOCAL_FINANCIAL_CATEGORIES: FinancialCategory[] = [
  { id: 'cat-income-maintenance', name: 'Mantenimiento', type: 'income', sortOrder: 1, isActive: true },
  { id: 'cat-income-renta-casa-club', name: 'Renta Casa Club', type: 'income', sortOrder: 2, isActive: true },
  { id: 'cat-income-tarjeta-acceso', name: 'Tarjeta de Acceso', type: 'income', sortOrder: 3, isActive: true },
  { id: 'cat-expense-agua', name: 'Agua', type: 'expense', sortOrder: 1, isActive: true },
  { id: 'cat-expense-alberca', name: 'Alberca', type: 'expense', sortOrder: 2, isActive: true },
  { id: 'cat-expense-camaras', name: 'Camaras', type: 'expense', sortOrder: 3, isActive: true },
  { id: 'cat-expense-casa-club', name: 'Casa Club', type: 'expense', sortOrder: 4, isActive: true },
  { id: 'cat-expense-cerrajeria', name: 'Cerrajeria', type: 'expense', sortOrder: 5, isActive: true },
  { id: 'cat-expense-comisiones', name: 'Comisiones Bancarias', type: 'expense', sortOrder: 6, isActive: true },
  { id: 'cat-expense-guardias', name: 'Guardias', type: 'expense', sortOrder: 7, isActive: true },
  { id: 'cat-expense-jardineria', name: 'Jardineria', type: 'expense', sortOrder: 8, isActive: true },
  { id: 'cat-expense-luz', name: 'Luz', type: 'expense', sortOrder: 9, isActive: true },
  { id: 'cat-expense-mantenimiento-general', name: 'Mantenimiento general', type: 'expense', sortOrder: 10, isActive: true },
  { id: 'cat-expense-panel-solar', name: 'Panel Solar', type: 'expense', sortOrder: 11, isActive: true },
  { id: 'cat-expense-recolectora', name: 'Recolectora', type: 'expense', sortOrder: 12, isActive: true },
  { id: 'cat-expense-residentia-qr', name: 'Residentia QR', type: 'expense', sortOrder: 13, isActive: true },
  { id: 'cat-expense-otro', name: 'Otro', type: 'expense', sortOrder: 14, isActive: true },
]
export const LOCAL_FINANCIAL_PERIOD_CLOSES: FinancialPeriodClose[] = [
  {
    id: 'period-close-2026-01',
    year: 2026,
    month: 1,
    openingBalanceMxn: 2228076.35,
    closingBalanceMxn: 2258405.66,
    notes: 'Corte publicado para residentes con detalle agregado por concepto.',
    publishedAt: new Date('2026-02-01T09:00:00-08:00').toISOString(),
    publishedByUserId: 'acc-board-1',
  },
]
export const LOCAL_FINANCIAL_MOVEMENTS: FinancialMovement[] = [
  {
    id: 'fin-income-2026-01-maint',
    type: 'income',
    category: 'Mantenimiento',
    amountMxn: 129600,
    occurredAt: new Date('2026-01-05T09:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Cobranza mensual de mantenimiento del periodo.',
    vendorOrSource: 'Cuotas vecinales',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-income-2026-01-renta',
    type: 'income',
    category: 'Renta Casa Club',
    amountMxn: 15000,
    occurredAt: new Date('2026-01-14T13:30:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Rentas de casa club del mes.',
    vendorOrSource: 'Amenidades',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-income-2026-01-tag',
    type: 'income',
    category: 'Tarjeta de Acceso',
    amountMxn: 1400,
    occurredAt: new Date('2026-01-21T11:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Reposicion de tarjetas vehiculares.',
    vendorOrSource: 'Control de acceso',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-agua',
    type: 'expense',
    category: 'Agua',
    amountMxn: 1631.6,
    occurredAt: new Date('2026-01-08T10:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Servicio de agua del area comun.',
    vendorOrSource: 'CESPT',
    visibilityScope: 'community',
    evidenceUrl: 'https://example.com/finanzas/agua-2026-01.pdf',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-casa-club',
    type: 'expense',
    category: 'Casa Club',
    amountMxn: 7500,
    occurredAt: new Date('2026-01-10T15:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Mantenimiento menor de la casa club.',
    vendorOrSource: 'Servicios Reforma',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-comisiones',
    type: 'expense',
    category: 'Comisiones Bancarias',
    amountMxn: 908.98,
    occurredAt: new Date('2026-01-11T09:30:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Comisiones por dispersion y manejo de cuenta.',
    vendorOrSource: 'Banco',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-guardias',
    type: 'expense',
    category: 'Guardias',
    amountMxn: 34289.88,
    occurredAt: new Date('2026-01-15T12:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Pago mensual del servicio de seguridad.',
    vendorOrSource: 'Seguridad Privada Norte',
    visibilityScope: 'community',
    evidenceUrl: 'https://example.com/finanzas/guardias-2026-01.pdf',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-iva-comision',
    type: 'expense',
    category: 'Iva por Comision Bancaria',
    amountMxn: 145.44,
    occurredAt: new Date('2026-01-15T12:05:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'IVA trasladado por comision bancaria.',
    vendorOrSource: 'Banco',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-jardineria',
    type: 'expense',
    category: 'Jardineria',
    amountMxn: 5657.75,
    occurredAt: new Date('2026-01-18T08:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Servicio mensual de jardineria.',
    vendorOrSource: 'Verde Vivo',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-mantenimiento',
    type: 'expense',
    category: 'Mantenimiento general',
    amountMxn: 18657.04,
    occurredAt: new Date('2026-01-20T14:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Mantenimiento correctivo de areas comunes.',
    vendorOrSource: 'Manto Integral',
    visibilityScope: 'community',
    evidenceUrl: 'https://example.com/finanzas/mantenimiento-general-2026-01.pdf',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-otro',
    type: 'expense',
    category: 'Otro',
    amountMxn: 8800,
    occurredAt: new Date('2026-01-23T16:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Gasto extraordinario aprobado por comite.',
    vendorOrSource: 'Proveedor local',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-recolectora',
    type: 'expense',
    category: 'Recolectora',
    amountMxn: 38080,
    occurredAt: new Date('2026-01-25T09:00:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Servicio de recoleccion y disposicion.',
    vendorOrSource: 'Recolectora MX',
    visibilityScope: 'community',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'fin-expense-2026-01-unit-private',
    type: 'expense',
    category: 'Mantenimiento',
    amountMxn: 2400,
    occurredAt: new Date('2026-01-28T09:30:00-08:00').toISOString(),
    periodYear: 2026,
    periodMonth: 1,
    description: 'Ajuste interno de reparacion cargado a la unidad 11-22.',
    vendorOrSource: 'Administracion interna',
    unitNumber: '11-22',
    visibilityScope: 'unit_private',
    createdByUserId: 'acc-board-1',
  },
]
export const LOCAL_UNIT_ACCOUNT_ENTRIES: UnitAccountEntry[] = [
  {
    id: 'unit-entry-2026-01-maint-charge-1122',
    unitNumber: '11-22',
    entryType: 'charge',
    category: 'Mantenimiento',
    amountMxn: 1800,
    direction: 'debit',
    occurredAt: new Date('2026-01-01T08:00:00-08:00').toISOString(),
    dueAt: '2026-01-10',
    status: 'paid',
    notes: 'Cuota ordinaria enero 2026.',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'unit-entry-2026-01-maint-payment-1122',
    unitNumber: '11-22',
    entryType: 'payment',
    category: 'Mantenimiento',
    amountMxn: 1800,
    direction: 'credit',
    occurredAt: new Date('2026-01-03T11:00:00-08:00').toISOString(),
    status: 'paid',
    notes: 'Pago recibido por SPEI.',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'unit-entry-2026-02-maint-charge-1122',
    unitNumber: '11-22',
    entryType: 'charge',
    category: 'Mantenimiento',
    amountMxn: 1800,
    direction: 'debit',
    occurredAt: new Date('2026-02-01T08:00:00-08:00').toISOString(),
    dueAt: '2026-02-10',
    status: 'overdue',
    notes: 'Cuota ordinaria febrero 2026.',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'unit-entry-2026-02-tag-charge-1122',
    unitNumber: '11-22',
    entryType: 'charge',
    category: 'Tarjeta de Acceso',
    amountMxn: 700,
    direction: 'debit',
    occurredAt: new Date('2026-02-09T08:00:00-08:00').toISOString(),
    dueAt: '2026-02-12',
    status: 'partial',
    notes: 'Reposicion de tarjeta vehicular.',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'unit-entry-2026-02-tag-payment-1122',
    unitNumber: '11-22',
    entryType: 'payment',
    category: 'Tarjeta de Acceso',
    amountMxn: 300,
    direction: 'credit',
    occurredAt: new Date('2026-02-10T18:00:00-08:00').toISOString(),
    status: 'partial',
    notes: 'Abono parcial a reposicion.',
    createdByUserId: 'acc-board-1',
  },
  {
    id: 'unit-entry-2026-01-maint-charge-1142',
    unitNumber: '11-42',
    entryType: 'charge',
    category: 'Mantenimiento',
    amountMxn: 1800,
    ...
    dueAt: '2026-01-10',
    status: 'pending',
    notes: 'Visible solo para la unidad 11-42 y comite.',
    createdByUserId: 'acc-board-1',
  },
]
