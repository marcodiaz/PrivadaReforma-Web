# Privada Reforma
## Documento Funcional Bilingue (ES/EN)

Version: v2
Fecha: 2026-02-20
Alcance: Mapeo de pantallas web + notas de implementacion React Native guard-first

---

## Indice / Table of Contents
1. Mapeo de screenshots (01-17)
2. Nota de navegacion (web/admin/residente)
3. Nota de alcance (placeholders vs modulos operativos)
4. React Native Implementation Notes (por pantalla)
5. Guard-Centric RN Modules (SOS, alert console, vibration/audio)
6. Publishing and Cost Strategy
